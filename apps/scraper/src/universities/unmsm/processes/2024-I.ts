/**
 * UNMSM 2024-I extractor
 *
 * Portal root : https://admision.unmsm.edu.pe/Website20241/
 * HTML format : old — plain text in <td> cells, DataTables 1.13.7
 * Modalities  : A (EBR/EBA) — only modality published for this process
 *
 * Run (snapshot mode):  pnpm extract:unmsm:2024-I
 * Run (live mode):      pnpm extract:unmsm:2024-I -- --live
 */
...
const PROCESS_ID = '2024-I';
const BASE_URL = 'https://admision.unmsm.edu.pe/Website20241';
const SLUG = 'unmsm';
